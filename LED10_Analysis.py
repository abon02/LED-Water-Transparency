...
CHARGE_MEAN_RATIOS = [1.534987094,	1.316762538,	1.992451495,	3.159432896,	1.115129814,	2.2577024,	1.774479618]
    ...
    for j,date in enumerate(data): # iterate over runs
        ...
        for t in TUBES: # iterate over PMTs
            ...
            if j==0: # the first date
                ...
                intensity_bases[t] = themean*CHARGE_MEAN_RATIOS[tcount] # scale to match data taken at default voltages at this PMT's default voltage
